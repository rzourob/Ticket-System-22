                ...
                <div class="card-body table-responsive p-1">
                    <table  id="example1" class="table table-bordered table table-striped " style="text-align: center">
                        <thead>
                            <tr>
                                <th>ID</th>
                                <th>{{trans('role_trans.name')}}</th>
                                <th>{{trans('role_trans.guard_name')}}</th>
                                <th>{{trans('role_trans.permissions')}}</th> 
                                <th>{{trans('role_trans.date_created')}}</th>
                                {{-- <th>{{trans('role_trans.update_at')}}</th> --}}
                                <th>{{trans('role_trans.action')}}</th>
