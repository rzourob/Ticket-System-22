    ...
    <div class="col-md-12 mb-30">     
        ...
        <div class="card-body">    
            ...
            <form>
                ...
                <h4> طلبات الأجهزة الطبية <span class="label label-default"></span></h4>
            </form>
        </div>
        </div>   
    </div>
                    ...
                    <div class="col-sm-6">
                        <div class="form-group ">
                          ...
                          {{-- <div class="input-group" data-date="23/11/2018" data-date-format="mm/dd/yyyy" id="searchDate">
                            ...
                            <div class="input-group input-daterange" data-date="23/11/2018" data-date-format="mm/dd/yyyy" >
                                <input type="text" class="form-control range-from" name="fromDate" id="fromDate">
    ...
    <div class="col-md-12 mb-30">
        <div class="card card-statistics h-100">
            <div class="card-body">
                <div class="col-md-2">
                    <div class="form-group">
                        <input type="text" id="devicesMedical-table-search" class="form-control" autofocus placeholder=" بحث ">
                    </div>
                </div>
