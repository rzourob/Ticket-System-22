...
<script>
    ...
    function performUpdate(id){
        ...
        update('/user/UpdateRequestIt/'+id,data);
    }
</script>
@endsection
...
<div class="row">
    ...
    <div class="col-md-12 mb-30">     
        <div class="card card-statistics h-100"> 
          <div class="card-body">    
            <h5 class="card-title">معلومات الأتصال</h5>
            <form >
                  <div class="row">
                  ...
                  <div class="row">
                      ...
                      <div class="col-md-4 mb-30">
                          <div class="col">
                              <label for="mobile" class="mr-sm-2">رقم الجوال</label>
                              <input type="text" name="mobile" class="form-control" id="mobile"
                              placeholder="ادخل mobile" value="{{$maintenancerequest->mobile}}">
                          </div>
                      </div> 
                  </div>
          </form>
          ...
          <form >
                ...
                <div class="row">
                    ...
                    <div class="col-md-3 mb-30">
                        <div class="col">
                            <label>أسم الوحدة</label>
                            <select class="custom-select" id="subdepartments" name="subdepartments" style="width: 100%;" class="custom-select" {{ $subdepartment->id == $maintenancerequest->subdepartment->id ? 'selected' : '' }}>
                                <option value="">يرجي أختيار اسم الوحدة</option>
                                @foreach ($subdepartments as $subdepartment)
            ...
            <div class="row">
                    <div class="col-md-12 mb-30">
                        <div class="col">
                            <label for="content">وصف المشكلة</label>
                            <textarea class="form-control" style="resize: none;"  type="text" id="content" name="content" rows="4"
                                placeholder="وصف المشكلة" cols="50">{{$maintenancerequest->title}}</textarea>
                        </div>
                    </div>                
            </div>                    
            <!-- /.card-body -->
            <div class="modal-footer">
                <button type="button" onclick="performUpdate({{$maintenancerequest->id}})" class="btn btn-primary">تحديث البيانات</button>
            </div>
        </form> 
        </div>
      </div>   
...
<script>
    ...
    function performUpdate(id){
        ...
        let redirectUrl = '/Request/deviceit'
        update('/Request/maintenances/'+id,data);
    }
</script>
@endsection
 --}}
