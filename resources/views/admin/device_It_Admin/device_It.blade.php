...
@section('PageTitle')
<div class="col-sm-12" >
    <h4 class="mb-0" style="font-family: 'Cairo', sans-serif"> عرض أجهزة تكنولوجيا المعلومات</h4>
  </div>
<!-- breadcrumb -->
...
<div class="row">
    <div class="col-md-2">
        <tbody>
            <tr>
                <td>
                    <a href="{{ route('admin.devices_It.create') }}" class="btn btn-block btn-outline-success btn-lg">أضافة
                        جهاز</a>
                </td>
            </tr>
        </tbody>
