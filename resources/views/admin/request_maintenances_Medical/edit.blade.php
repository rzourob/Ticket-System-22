                ...
                <form>
                        ...
                        <div class="col-sm-4">
                            ...
                            <div class="form-group">
                                ...
                                <select class="custom-select" id="deviceTypes" disabled>
                                    ...
                                    <option value="2"
                                        {{ $maintenancerequest->deviceTypes == '2' ? 'selected' : '' }}>تكنولوجيا
                                        المعلومات</option>
                                    <option value="3"
                                        {{ $maintenancerequest->deviceTypes == '3' ? 'selected' : '' }}>هندسة وصيانة
                                    </option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4 mb-30">
                            <div class="col">
                                ...
                                <input type="email" name="author_email" class="form-control" id="author_email"
                                    disabled placeholder=" يرجي ادخل البريد الاكتروني" data-max="6" required
                                    value="{{ $maintenancerequest->author_email }}">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class="col">
                                <label> القسم</label>
                                <select class="custom-select" id="departments" style="width: 100%;" disabled>
                                    <option value="">أختار القسم</option>
                                    @foreach ($departments as $department)
                                        <option value="{{ $department->id }}"
                                            {{ $department->id == $maintenancerequest->department->id ? 'selected' : '' }}>
                        ...
                        <div class="col-md-3 mb-30">
                            <div class="col">
                                ...
                                <input type="text" name="device_id" class="form-control" id="device_id" disabled
                                    placeholder="{{ trans('maintenance_trans.enter_email') }}" data-max="6" required
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class="col">
                                ...
                                <input type="text" name="model" class="form-control" id="model" disabled
                                    placeholder="{{ trans('maintenance_trans.enter_email') }}" data-max="6" required
                                    value="{{ $maintenancerequest->model }}">
                            </div>
                        </div>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" name="room" class="form-control" id="room" disabled
                                    placeholder="يرجي أدخال رقم الغرفة" data-max="6" required
                                    value="{{ $maintenancerequest->room }}">
                            </div>
                        </div>
                        ...
                        <div class="col-md-4 mb-30">
                            <div class="col">
                                ...
                                <input type="text" name="sn" class="form-control" id="sn" disabled
                        ...
                        <div class="col-sm-4">
                            ...
                            <div class="form-group">
                                ...
                                <select class="custom-select" id="status">
                                    <option value=""> اختارح نوع الطلب</option>
                                    <option value="1"
                                        {{ $maintenancerequest->status == 'Todo' ? 'selected' : '' }}>مفتوحة</option>
                                    <option value="2"
                                        {{ $maintenancerequest->status == 'Done' ? 'selected' : '' }}>مغلقة</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="col-md-12 mb-30">
                            <div class="col">
                                ...
                                <textarea class="form-control" style="resize: none;" type="text" id="content" name="content" rows="4"
                                    disabled placeholder="وصف المشكلة" cols="50">{{ $maintenancerequest->content }}</textarea>
                            </div>
                        </div>
                    </div>
                    <!-- /.card-body -->
...
<script>
    function performUpdate(id) {
        ...
        update('/admin/maintenance_Medical/update/' + id, data);
    }
</script>
@endsection
