...
<div class="row">   
    <div class="col-md-12 mb-30">     
      <div class="card card-statistics h-100"> 
        <div class="card-body">    
          <h5 class="card-title">بيانات الجهاز</h5>
          <form >
                <div class="row">
                    ...
                    <div class="col-md-4 mb-30">
                        <div class="col">
                            ...
                            <input type="email" name="author_email" class="form-control" id="author_email" disabled
            ...
            <div class="row">
                    <div class="col-md-12 mb-30">
                        <div class="col">
                            ...
                            <textarea class="form-control" style="resize: none;"  type="text" id="content" name="content" rows="4" disabled
