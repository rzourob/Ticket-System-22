                ...
                <div class="tab round">
                    <ul class="nav nav-tabs" role="tablist">
                        ...
                        {{-- <li class="nav-item">
                              ...
                              aria-controls="contact-07" aria-selected="false"><i class="fa fa-check-square-o"></i> Contact </a>
                            </li> --}}
                    </ul>
                                                ...
                                                <div class="card card-statistics">
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        <form>
                                                            ...
                                                            <div class="">
                                                                <button type="button" name="uploadedFile"
                                                        ...
                                                        @foreach ($deviceattachments as $deviceattachment)
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <a class="btn btn-info" href="{{ route('View_file_Admin_pdf', $deviceattachment->id)}}"  role="button">عرض
