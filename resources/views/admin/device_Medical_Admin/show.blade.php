            ...
            <div class="card-body">
                ...
                <div class="tab round">
                    ...
                    <div class="tab-content">
                        ...
                        @include('admin.device_Medical_Admin.form.device_movements.deviceMovement')

                        @include('admin.device_Medical_Admin.form.device_attachment.deviceattachment')
                        
                        @include('admin.device_Medical_Admin.form.accessory_medical.accessorymedical')
