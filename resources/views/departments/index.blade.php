            ...
            <div class="card-body">
                <div class="col-md-2">
                    <div class="form-group">
                        <input type="text" id="departments-table-search" class="form-control" autofocus placeholder=" بحث ">
                    </div>
                </div>
                <div class="table-responsive">
                    <table id="departments-table" class="table table-striped table-bordered p-0"  class="table datatable" >
                      <thead>
                            <tr>
                                <th>No.</th>
                                <th>أسم القسم</th>
...
<script>
    ...
    let departmentTable = $('#departments-table').DataTable({
        dom: "tiplr",
        responsive: true,
        serverSide: true,
        processing: true,
    ...
    $('#departments-table-search').keyup(function () {
