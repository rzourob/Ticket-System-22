...
<div class="row">
    <div class="col-md-2">
        <tbody>
            <tr>
                <td>
                    <a href="{{ route('admin.devices_It.create') }}"
                        class="btn btn-block btn-outline-success btn-lg">أضافة جهاز</a>
                </td>
            </tr>
        </tbody>
    </div>
        ...
        <div class="card card-statistics h-100">
            <div class="card-body">
                ...
                <form>
                    ...
                    <h4 style="font-family: 'Cairo', sans-serif ; color: #8d183d;"> قائمة أجهزة تكنلوجيا المعلومات </h4>
                </form>
            </div>
        </div>
    </div>
...
<div class="row">
    <div class="col-md-12 mb-30">
        <div class="card card-statistics h-100">
            <div class="card-body">
                <h5 class="card-title" style="font-family: 'Cairo', sans-serif ; color: #8d183d;">فلترة البيانات</h5>
                <form>
                    <div class="row">
                        <div class="col-sm-3 ">
                            <!-- select -->
    ...
    <div class="col-md-12 mb-30">
        <div class="card card-statistics h-100">
            <div class="card-body">
                <div class="col-md-2">
                    <div class="form-group">
                        <input type="text" id="devicesIt-table-search" class="form-control" autofocus
                            placeholder=" بحث ">
                    </div>
                </div>
                <div class="table-responsive">
                    <table id="devicesIt-table" class="table table-striped table-bordered p-0" class="table datatable">
                        <thead>
                            <tr>
                                <th>No.</th>
                                <th>صورة الجهاز</th>
...
<script>
    let devicesItTable = $('#devicesIt-table').DataTable({
        dom: "tiplr",
        responsive: true,
        serverSide: true,
        processing: true,
        ajax: {
            url: '{{ route('DevicesIt.data') }}',
        },
        columns: [
    ...
    $('#subdepartments').change(function() {
        $('#devicesIt-table').dataTable().fnFilter($(this).val(), -6);
    });
