            ...
            <div class="card-body">
                ...
                <div class="tab round">
                    ...
                    <div class="tab-content">
                        ...
                        @include('admins.devices.it_devices.form.device_movements.deviceMovement')

                        @include('admins.devices.it_devices.form.device_attachment.deviceattachment')
                        
                        @include('admins.devices.it_devices.form.accessory_it.accessoryit')
