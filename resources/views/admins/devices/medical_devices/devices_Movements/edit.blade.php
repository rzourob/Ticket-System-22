                        ...
                        <div class="col-sm-4 mb-30">
                            ...
                            <div class="col">
                                ...
                                <select class="custom-select" id="new_status">
                                    ...
                                    <option value="1"  {{ $deviceMovements->new_status == "1"  ? 'selected' : ''}}>مفتوحة</option>
                                    <option value="2" {{ $deviceMovements->new_status == "2"  ? 'selected' : ''}}>مغلقة</option>
                                </select>
                            </div>
                        </div>
...
<script>
    function performUpdate(id) {
        ...
        let redirectUrl = '/admin/devices_Medical'
            update('/admin/Movements_Medicl/update/'+id,data,redirectUrl);
    }
</script>
