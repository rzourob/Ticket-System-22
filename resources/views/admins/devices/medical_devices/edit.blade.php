...
<div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-3">
                            ...
                            <div class="form-group">
                                ...
                                <select class="custom-select" id="deviceTypes">
                                    <option value=""> اختارح نوع الجهاز</option>
                                    <option value="1" {{ $devices->deviceTypes == '1' ? 'selected' : '' }}> جهاز
                                        طبي</option>
                                    <option value="2" {{ $devices->deviceTypes == '2' ? 'selected' : '' }}>
                                        تكنولوجيا المعلومات</option>
                                    <option value="3" {{ $devices->deviceTypes == '3' ? 'selected' : '' }}>هندسة
                                        وصيانة</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <select class="custom-select" id="departments" style="width: 100%;">
                                    ...
                                    @foreach ($departments as $department)
                                        <option
                                            value="{{ $department->id }}"{{ $department->id == $devices->department->id ? 'selected' : '' }}>
                                            {{ $department->title }}</option>
                                    @endforeach
                                </select>
                            </div>
    ...
    <div class="col-md-12 mb-30">
        <div class="card card-statistics h-100">
            <div class="card-body">
                <h5 class="card-title">معلومات الشركة المصنعة</h5>
                <form>
                    <div class="row">
...
<script>
    function performUpdate() {
        ...
        store('/admin/devices_Medical/update/{{ $devices->id }}', formData);
    }
</script>
@endsection
