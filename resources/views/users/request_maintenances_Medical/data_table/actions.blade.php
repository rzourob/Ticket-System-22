<div class="btn-group mb-1">
	...
	<div class="dropdown-menu" x-placement="bottom-start" style="position: absolute; transform: translate3d(0px, 33px, 0px); top: 0px; left: 0px; will-change: transform;">
		<a class="dropdown-item" href="{{ route('user.Request_Medical.edit',$id) }}"><i class="fa fa-pencil-square-o" aria-hidden="true"></i>
			تعديل بيانات</a>
		...
		<a class="dropdown-item" href="{{ route('user.cmmentShowMed.data',$id) }}"><i class="fa fa-eye" aria-hidden="true"></i>
			أضافة رد</a>
