    ...
    <div class="btn-group mb-1">
        ...
        <div class="dropdown-menu" x-placement="bottom-start"
            ...
            @can('عرض تفاصيل الجهاز')
                <a class="dropdown-item" href="{{ route('user.devices_Medical.show', $id) }}"><i class="fa fa-eye" aria-hidden="true"></i>
                    عرض تفاصيل الجهاز</a>
            @endcan

            @can('أضافة حركة')
                <a class="dropdown-item" href="{{ route('user.Movements_Medical', $id) }}"><i class="fa fa-eye"
                        aria-hidden="true"></i>
                    أضافة حركة</a>
            @endcan
