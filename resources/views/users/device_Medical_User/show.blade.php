            ...
            <div class="card-body">
                ...
                <div class="tab round">
                    ...
                    <div class="tab-content">
                        ...
                        @include('users.device_Medical_User.form.device_movements.deviceMovement')

                        @include('users.device_Medical_User.form.device_attachment.deviceattachment')
                        
                        @include('users.device_Medical_User.form.accessory_medical.accessorymedical')
