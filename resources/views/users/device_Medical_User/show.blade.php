                            ...
                            <div class="row invoice-info">
                                ...
                                <div class="col-sm-12 invoice-col">
                                    ...
                                    <div class="row no-print col-md-12 text-center table-responsive p-20">
                                        <div class="col-12">
                                            <a class="btn btn-primary btn-outline backForm btn-lg " href="{{ route('user.DevicesMedical') }}"
...
<script type="text/javascript">
   ...
   store('/admin/Attachments',formData);
}
...
confirmDestroy('/admin/Attachments/'+id,ref);    
