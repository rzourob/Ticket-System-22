        ...
        <div class="card card-statistics h-100">
            <div class="card-body">
                ...
                <form id="create_form">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group mb-3">
                                <input type="text" class="form-control" name="name" id="name"
                                    placeholder="يرجى أدخال اسم المستخدم" aria-label="Recipient's username"
                                    aria-describedby="basic-addon2" value="{{ $user->name }}">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group mb-3">
                                <input type="email" class="form-control" name="email" id="email"
                                    placeholder="يرجي أدخال البريد الاكتروني" aria-label="Recipient's username"
                                    aria-describedby="basic-addon2" value="{{ $user->email }}">
                                <div class="input-group-append">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <label for="password" class="mr-sm-2">
                                <h5>كلمة المرور</h5>
                            </label>
                            <div class="input-group mb-3">
                                <input type="password" class="form-control" name="password" id="password"
                                    placeholder="يرجى أدخال كلمة المرور" aria-label="Recipient's username"
                        ...
                        <div class="col-md-6">
                            <label for="password_confirmation" class="mr-sm-2">
                                <h5>تاكيد كلمة المرور</h5>
                            </label>
                            <div class="input-group mb-3">
                                <input type="text" class="form-control" name="password_confirmation"
                                    id="password_confirmation" placeholder="يرجى أدخال اسم المستخدم"
                        ...
                        <div class="col-md-6">
                            <div class="col">
                                ...
                                <select class="custom-select" id="status">
                                    ...
                                    <option value="مفعل" {{ $user->status == 'مفعل' ? 'selected' : '' }}>مفعل
                                    </option>
                                    <option value="غير مفعل" {{ $user->status == 'غير مفعل' ? 'selected' : '' }}>غير
                                        مفعل</option>
                                </select>
                            </div>
                        </div>
                    ...
                    <div class="modal-footer">
                        <button type="button" onclick="performUpdate()" class="btn btn-primary">تعديل
                            البيانات</button>
                    </div>
                </form>
            </div>
...
<script>
    ...
    function performUpdate() {
        ...
        store('/admin/users/{{ $user->id }}', formData);
    }
</script>
@endsection
