                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3 mb-30">
                                            <div class="col">
                                                ...
                                                <input type="text" name="sn22" class="form-control" id="sn22"
                                                    placeholder="ادخل SN">
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="title22" class="form-control" id="title22"
                                                    placeholder="">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="model22" class="form-control"
                                                    id="model22" placeholder="">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="room22" class="form-control"
