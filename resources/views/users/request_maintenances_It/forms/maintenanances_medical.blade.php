                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <select class="custom-select" id="departments22" style="width: 100%;">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3 mb-30">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="sn" class="form-control" id="sn22"
                                                    placeholder="ادخل SN">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="title" class="form-control" id="title22"
                                                    placeholder="">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="model" class="form-control" id="model22"
                                                    placeholder="">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="room" class="form-control"
                                                    id="room22" placeholder="" data-max="6" required>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 mb-30">
                                            <div class="col">
                                                ...
                                                <select class="custom-select" name="problems" id="problems22">
                                        ...
                                        <div class="col-md-6 mb-30 ">
                                            <div class="col">
                                                ...
                                                <select class="custom-select" name="subproblems" id ="subproblems22">
                                                    <option value=""> اختارح نوع المشكلة</option>
