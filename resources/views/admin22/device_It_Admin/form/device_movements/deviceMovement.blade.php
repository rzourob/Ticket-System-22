            ...
            <div class="card-body">
                <div class="card-text">
                    ...
                    <div class="modal-footer" class="d-flex justify-center align-center">
                        ...
                        <a  href="{{ route('admin.Movements_it.edit', $deviceMovement->id) }}" class="btn btn-success left justify-center"><i class="fa fa-trash-o" aria-hidden="true"></i>
                            تعديل الرد
                        </a>


                        <a href="#"
                        onclick="performDestroy10({{ $deviceMovement->id }},this)  "
