...
namespace App\Http\Controllers\Technician\Maintenance_Technician;
...
class RequestMaintenanceTeMedicalController extends Controller
{
    const MEDICAL = 2;
    ...
    public function index()
    {
        ...
        return view('technician.request_Technician.viewRequestMedical', [
