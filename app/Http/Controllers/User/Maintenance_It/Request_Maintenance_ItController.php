...
namespace App\Http\Controllers\User\Maintenance_It;
...
class Request_Maintenance_ItController extends Controller
{
...

    {
        return DataTables::of(MaintenanceRequest::where('department_id', auth()->user()->department_id)->where('deviceTypes', 2))
            ...
            ->addColumn('tiket_no', function (maintenancerequest $maintenancerequest) {
                return view('users.request_maintenances_It.data_table.tiket_no', compact('maintenancerequest'));
            })

            ->addColumn('title', function (maintenancerequest $maintenancerequest) {
                return view('users.request_maintenances_It.data_table.subject', compact('maintenancerequest'));
            })

            ->addColumn('department_id', function (maintenancerequest $maintenancerequest) {
                return view('users.request_maintenances_It.data_table.departments', compact('maintenancerequest'));
            })

            ->addColumn('sub_department_id', function (maintenancerequest $maintenancerequest) {
                return view('users.request_maintenances_It.data_table.subdepartments', compact('maintenancerequest'));
            })

            ->addColumn('status', function (maintenancerequest $maintenancerequest) {
                return view('users.request_maintenances_It.data_table.active', compact('maintenancerequest'));
            })

            ->addColumn('deviceTypes', function (maintenancerequest $maintenancerequest) {
                return view('users.request_maintenances_It.data_table.deviceTypes', compact('maintenancerequest'));
            })

            ->editColumn('created_at', function (maintenancerequest $maintenancerequest) {
                return $maintenancerequest->created_at->format('Y-m-d');
            })
            ->addColumn('actions', 'users.request_maintenances_It.data_table.actions')
            ->rawColumns(['actions'])
            ->toJson();
    } // end of data
    ...
    public function show($id)
    {
        ...
        return response()->view('users.request_maintenances_It.show', [
            'maintenancerequests' => $maintenancerequests,
            'devices' => $devices,
            'comments' => $comments
        ]);
    ...
    public function edit( $id)
    {
        ...
        return response()->view('users.request_maintenances_It.edit', [
