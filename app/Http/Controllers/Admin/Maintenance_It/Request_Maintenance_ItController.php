...
class Request_Maintenance_ItController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.request_maintenances_It.Request_Devices_It', [
...

    {
        return DataTables::of(MaintenanceRequest::query()->where('deviceTypes', 2))
            ...
            ->addColumn('tiket_no', function (maintenancerequest $maintenancerequest) {
                return view('admin.request_maintenances_It.data_table.tiket_no', compact('maintenancerequest'));
            })

            ->addColumn('title', function (maintenancerequest $maintenancerequest) {
                return view('admin.request_maintenances_It.data_table.title', compact('maintenancerequest'));
            })

            ->addColumn('department_id', function (maintenancerequest $maintenancerequest) {
                return view('admin.request_maintenances_It.data_table.departments', compact('maintenancerequest'));
            })

            ->addColumn('sub_department_id', function (maintenancerequest $maintenancerequest) {
                return view('admin.request_maintenances_It.data_table.subdepartments', compact('maintenancerequest'));
            })

            ->addColumn('status', function (maintenancerequest $maintenancerequest) {
                return view('admin.request_maintenances_It.data_table.active', compact('maintenancerequest'));
            })

            ->addColumn('deviceTypes', function (maintenancerequest $maintenancerequest) {
                return view('admin.request_maintenances_It.data_table.deviceTypes', compact('maintenancerequest'));
            })

            ->editColumn('created_at', function (maintenancerequest $maintenancerequest) {
                return $maintenancerequest->created_at->format('Y-m-d');
            })
            ->addColumn('actions', 'admin.request_maintenances_It.data_table.actions')
            ->rawColumns(['actions'])
            ->toJson();
    } // end of data
    ...
    public function show($id)
    {
        ...
        return response()->view('admin.request_maintenances_It.show', [
            'maintenancerequests' => $maintenancerequests,
            'devices' => $devices,
            'comments' => $comments
        ]);
    ...
    public function edit( $id)
    {
        ...
        return response()->view('admin.request_maintenances_It.edit', [
