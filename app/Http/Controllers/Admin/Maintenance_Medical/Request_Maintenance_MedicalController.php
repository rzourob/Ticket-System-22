...
namespace App\Http\Controllers\Admin\Maintenance_Medical;
...
class Request_Maintenance_MedicalController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.request_maintenances_Medical.Request_Request_Devices_Medical', [
...

    {
        return DataTables::of(MaintenanceRequest::query()->where('deviceTypes', 1))
            ...
            ->addColumn('tiket_no', function (maintenancerequest $maintenancerequest) {
                return view('admin.request_maintenances_Medical.data_table.tiket_no', compact('maintenancerequest'));
            })

            ->addColumn('title', function (maintenancerequest $maintenancerequest) {
                return view('admin.request_maintenances_Medical.data_table.title', compact('maintenancerequest'));
            })

            ->addColumn('department_id', function (maintenancerequest $maintenancerequest) {
                return view('admin.request_maintenances_Medical.data_table.departments', compact('maintenancerequest'));
            })

            ->addColumn('sub_department_id', function (maintenancerequest $maintenancerequest) {
                return view('admin.request_maintenances_Medical.data_table.subdepartments', compact('maintenancerequest'));
            })

            ->addColumn('status', function (maintenancerequest $maintenancerequest) {
                return view('admin.request_maintenances_Medical.data_table.active', compact('maintenancerequest'));
            })

            ->addColumn('deviceTypes', function (maintenancerequest $maintenancerequest) {
                return view('admin.request_maintenances_Medical.data_table.deviceTypes', compact('maintenancerequest'));
            })

            ->editColumn('created_at', function (maintenancerequest $maintenancerequest) {
                return $maintenancerequest->created_at->format('Y-m-d');
            })
            ->addColumn('actions', 'admin.request_maintenances_Medical.data_table.actions')
            ->rawColumns(['actions'])
            ->toJson();
    } // end of data
    ...
    public function create()
    {
        ...
        return response()->view('admin.request_maintenances_Medical.create', ['subdepartments' => $subdepartments, 'departments' => $departments, 'devices' => $devices]);
    }
    ...
    public function show($id)
    {
        ...
        return response()->view('admin.request_maintenances_Medical.show', [
            'maintenancerequests' => $maintenancerequests,
            'devices' => $devices,
            'comments' => $comments
        ]);
    ...
    public function edit( $id)
    {
        ...
        return response()->view('admin.request_maintenances_Medical.edit', [
    ...
    public function comment_show($id)
    {
        ...
        return response()->view('admin.request_maintenances_Medical.cmment', ['maintenancerequests' => $maintenancerequests, 'comments' => $comments]);
    }
